...
console.log("INVENTORY_API_URL:", process.env.INVENTORY_API_URL);
console.log("INVENTORY_PORT:", process.env.INVENTORY_PORT);
...
// const RABBIT_CONFIG = {
//   url: `amqp://${process.env.RABBITMQ_USER}:${process.env.RABBITMQ_PASSWORD}@${process.env.BILLING_API_URL}:${process.env.RABBITMQ_PORT}`,
//   queue: process.env.RABBITMQ_QUEUE,
//   timeout: 5000,
// };
